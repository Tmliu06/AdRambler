...
from .input_policy import UtgBasedInputPolicy, UtgNaiveSearchPolicy, UtgGreedySearchPolicy, UtgGreedyAdSearchPolicy,\
                         UtgReplayPolicy, \
                         ManualPolicy, \
                         POLICY_NAIVE_DFS, POLICY_GREEDY_DFS, \
                         POLICY_NAIVE_BFS, POLICY_GREEDY_BFS, \
                         POLICY_AD_DFS, POLICY_AD_BFS, \
...
class InputManager(object):
    ...
    def get_input_policy(self, device, app, master):
        ...
        elif self.policy_name in [POLICY_AD_DFS, POLICY_AD_BFS]:
            input_policy = UtgGreedyAdSearchPolicy(device, app, self.random_input, self.policy_name)
