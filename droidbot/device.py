...
class Device(object):
    ...
    def __init__(self, device_serial=None, is_emulator=False, output_dir=None,
                 ...
                 enable_accessibility_hard=False, humanoid=None, ignore_ad=False, app=None):
        """
        ...
        self.droidbot_app = DroidBotAppConn(device=self, app=app)
    ...
    def install_app(self, app):
        ...
        if package_name not in self.adb.get_installed_apps():
            ...
            # wait for 180s to install one app
            sleep_time = 0
        ...
        while True:
            ...
            dumpsys_lines.append(line.replace('\r\r\n', '\n'))
        if self.output_dir is not None:
    ...
    def uninstall_app(self, app):
        ...
        if package_name in self.adb.get_installed_apps():
            ...
            # wait for 90s to uninstall one app
            sleep_time = 0
